            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="workflow" id="workflow" class="form-control" rows="4">{{ old('workflow') }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="processing_time" id="processing_time" class="form-control" 
                               value="{{ old('processing_time') }}" placeholder="Contoh: 3-5 hari kerja">
                    </div>
                    
                    <div class="form-group">
                        <label for="cost">Biaya</label>
                        <input type="text" name="cost" id="cost" class="form-control" 
                               value="{{ old('cost') }}" placeholder="Contoh: Gratis atau Rp 50.000">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="office" id="office" class="form-control" 
                               value="{{ old('office') }}" placeholder="Contoh: Ruang PTSP Lt. 1">
                    </div>
