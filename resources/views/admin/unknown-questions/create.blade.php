            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-group" id="answerField">
                        ...
                        <textarea name="answer" id="answer" class="form-control" rows="4">{{ old('answer') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tags" id="tags" class="form-control" 
                               value="{{ old('tags') }}" placeholder="Contoh: cuti, izin, surat">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="priority" id="priority" class="form-control" 
                                       value="{{ old('priority', 100) }}" min="0" max="100">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
