...
@section('title', 'Edit User - Edit Pengguna')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('role_name') is-invalid @enderror" 
                                ...
                                <option value="editor" {{ old('role_name', $user->role_name) == 'editor' ? 'selected' : '' }}>Editor</option>
                                <option value="operator" {{ old('role_name', $user->role_name) == 'operator' ? 'selected' : '' }}>Operator</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
