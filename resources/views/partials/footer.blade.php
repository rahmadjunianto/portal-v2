        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8" role="navigation" aria-label="Navigasi Footer">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('accessibility') }}" class="hover:text-emerald-400 transition-colors flex items-center gap-1">
                    ...
                    <li><a href="{{ route('privacy') }}" class="hover:text-emerald-400 transition-colors flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
